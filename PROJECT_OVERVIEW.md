...
### Project Snapshot
┌─────────────────────────────────────────────────────────────────┐
│  Duration:        3-4 week implementation      		   │
│  Cloud Provider:  AWS                                            │
...
- Business Problem: Photo-sharing applications for cultural events face several challenges:  
...
- Solution: Changed Terraform configuration to use major version only. Let AWS auto-select latest minor version  
```
...
Learning Phase (8 months):
├─ AWS Fundamentals:          80 hours
├─ Terraform:                 60 hours
...
Implementation Phase (3 week):
├─ Infrastructure Setup:      8 hours
├─ Application Development:   20 hours
├─ CI/CD Configuration:       6 hours
...
| [**🏗️ ARCHITECTURE**](docs/architecture/README.md)        | Detailed architecture documentation  |
| [**🚀 DEPLOYMENT**](docs/deployment/README.md)           | Complete deployment guide            |
| [**🔧 TROUBLESHOOTING**](docs/troubleshooting/README.md) | Issue resolution guide               |
| [**💻 IMPLEMENTATION**](docs/implementation/README.md)   | Technical implementation details     |
| [**🔐 SECURITY**](docs/security/README.md)               | Security practices and guidelines    |
...
- GitHub: @SHUBHADEEPXT
- Project Repository: Durga-Puja_Website_Project
- For questions, issues, or collaboration:
	- 📧 Email: shubhadeep010@gmail.com
	- 💬 Open an Issue
- 🔗 Connect on LinkedIn: https://www.linkedin.com/in/shubhadeep-bhowmik-74b5a214b/  
...
Made with ❤️ and countless hours of learningg  
